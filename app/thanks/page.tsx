...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    //   currency: searchParams.get("currency") || "PHP",
    //   paymentMethod:
    ...
    // Send confirmation email (in real app, this would be handled by backend)
    // if (details.customerEmail) {
    //   console.log("Sending confirmation email to:", details.customerEmail);
    // }
  }, [searchParams]);
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900">VIP Badge</h4>
                        <p className="text-sm text-gray-600">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <p className="text-sm text-gray-600">
                    Our team is here to help you get the most out of your DriveX
                    experience.
                  </p>
